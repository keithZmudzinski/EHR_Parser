...
def extract(corpus, types=[]):
    ...
    # Use the text above
    if corpus != 'pitt':
        # args['text'] = texts[corpus]
        # For using multiple texts
        args['text'] = [text, text4]
